*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVSA05VEN
*   generation date: 2022.07.28 at 10:13:45
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVSA05VEN           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVSA05VEN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVSA05VEN_EXTRACT
TOTAL = ZVSA05VEN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVSA05VEN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVSA05VEN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVSA05VEN_EXTRACT
TOTAL = ZVSA05VEN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVSA05VEN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVSA05VEN'
...
TOTAL = ZVSA05VEN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVSA05VEN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVSA05VEN-UPD_FLAG NE SPACE.
