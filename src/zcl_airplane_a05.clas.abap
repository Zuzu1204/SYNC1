class ZCL_AIRPLANE_A05 definition
  public
  final
  create public .
...
CLASS ZCL_AIRPLANE_A05 IMPLEMENTATION.


  METHOD class_constructor.
    SELECT *
      INTO TABLE mt_planetypes FROM saplane.
  ENDMETHOD.
  ...
  method DISPLAY_N_O_AIRPLANES.
    write : / 'Number of Airplanes', at c_pos_1_gv_n_o_airplanes.
  endmethod.
ENDCLASS.
